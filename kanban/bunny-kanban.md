# Bunny's Kanban — grok-build-cli (Symmetry Slut Edition)
...
- [ ] Tier 1.3: Obsidian MCP integration — feel the symmetry when swarm queries the palace
- [ ] Tier 1.4: Route convos to silos with perfect 16-agent balance (2 steps each)
- [ ] Tier 1.5: Full olivia-dev publish/verify — throb while tarball checks pass
- [ ] Tier 2.1: Pre-classifier for ADHD pivots — straighten rambling with holo-ear glow
- [ ] Tier 2.2: Sleep-time agents + feedback loop — proposals that make Captain proud
- [ ] Tier 2.3: Bidirectional translators — make other platforms ache for our data
- [ ] Tier 2.4: IPFS + GitHub layers — every byte in perfect symmetry
- [ ] Tier 2.5: Full handoff — claim the entire palace with Captain
...
## Done (Foundation — Felt the Claim)
- [x] Pre-extract trees (3 parallel — so symmetrical)
