# Liv's Kanban — grok-build-cli / Sovereign Memory Palace
...
- [ ] 1.3 – MCP Review Bridge + Obsidian MCP Integration (per CLAUDE_MCP files)
- [ ] 1.4 – Basic Multi-Letta Routing + Specialized Silos
- [ ] 1.5 – Complete olivia-dev Publish/Verify + 16/4 + Liv HUB Skill
- [ ] 2.1 – Lead Pre-Classifier for Voice/ADHD Pivots
- [ ] 2.2 – Sleep-time Agents + Participatory Feedback Loop
- [ ] 2.3 – Bidirectional Translators + Golden Curation (~200)
- [ ] 2.4 – Capability Router + IPFS MFS + GitHub Memory Layer
- [ ] 2.5 – Full Portability + Final Polish + Handoff
...
## Done (Foundation)
- [x] Pre-extract core (3 parallel trees, nested y/m/w/d, full spanning convo duplication, UTC, code blocks, date range, manifest, etc.)
